    ...
    <tr>
      <td align="center" style="padding: 40px 20px 40px 20px;">
        ...
        <table width="600" border="0" cellspacing="0" cellpadding="0" bgcolor="#F4E8D5" style="max-width:600px;">
          ...
          <!-- CONTENT (LEFT ALIGNED + CENTER BUTTON) -->
          <tr>
            <td style="padding: 0 40px 40px 40px; color:#333; font-size:16px; line-height:26px; text-align:left;">
              ...
              <!-- ONBOARDING BUTTON CENTERED -->
              <table border="0" cellspacing="0" cellpadding="0" width="100%" style="margin: 30px 0;">
                <tr>
                  <td align="center">
                    <a href="${invitationLink}" 
                       style="display:inline-block; padding: 12px 24px; background-color:#000; color:#fff; text-decoration:none; border-radius:16px; font-weight:500; font-size:14px;">
                      Complete Onboarding
                    </a>
                  </td>
                </tr>
...
exports.filterAgenciesByRadius = async (req, res) => {
    try {
        ...
        // If no agencies found, add default Foster Toys agency
        if (agencies.length === 0) {
            const defaultFosterToysAgency = {
                _id: "foster-toys-default",
                organization_name: "Foster Toys",
                shipping_address: "Sacramento, CA 95814",
                geocoded_address: "Sacramento, CA 95814",
                contact_phone: "(916) 483-0330",
                amazon_public: "https://www.amazon.com/hz/wishlist/ls/3NOW5IHJA7V6L?ref_=wl_share",
                distanceInMiles: 0,
                distanceInMeters: 0
            };
            agencies.push(defaultFosterToysAgency);
            console.log("No agencies found, adding default Foster Toys agency");
        }
